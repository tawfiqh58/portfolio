!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      var o = n(47),
        ...
        u = o(
          ...
          : function (t) {
              return (
                r(t) && a.call(t, "callee") && !s.call(t, "callee")
              );
            };
      t.exports = u;
    },
        ...
        function e() {
          ...
          return (
            ...
            (i.positionBoxes = function () {
              var t =
                  -parseFloat(i.options.handleStyles.width) / 2 +
                  "px",
                e =
                  -parseFloat(i.options.handleStyles.height) / 2 +
                  "px";
              [
                { left: t, top: e },
                { right: t, top: e },
    ...
    function (t, e, n) {
      ...
      (e.default = f),
        window.Quill &&
          window.Quill.register("modules/imageResize", f);
    },
    function (t, e, n) {
      function o(t) {
        var e = -1,
