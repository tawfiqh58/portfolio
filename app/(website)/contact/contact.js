...
export default function Contact({ settings }) {
  ...
  // Web3Forms API using email address
  const apiKey = "9d4525ac-68e9-439e-b472-66152ebd59cc";

  const { submit: onSubmit } = useWeb3Forms({
    access_key: apiKey,
    settings: {
      from_name: "Tawfiq Hasan",
      subject: "Contact Message from Tawfiq Hasan"
    },
    onSuccess: (msg, data) => {
      setIsSuccess(true);
      setMessage(msg);
  ...
  return (
    <Container>
      ...
      <div className="text-center">
        <p className="text-lg">I am free to work.</p>
      </div>
        ...
        <div className="my-10">
          ...
          <div className="mt-5">
            <div className="text-dark-600 mt-2 flex items-center space-x-2 dark:text-gray-400">
              ...
              <span>Upashahar Road, Rajshahi</span>
            </div>
            {settings?.email && (
              <div className="text-dark-600 mt-2 flex items-center space-x-2 dark:text-gray-400">
